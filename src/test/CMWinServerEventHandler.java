...
public class CMWinServerEventHandler implements CMAppEventHandler {
    ...
    private void processUserEvent(CMEvent cme) {
        ...
        if (ue.getStringID().equals("testNotForward")) {
            ...
            if (nChType == CMInfo.CM_SOCKET_CHANNEL) {
                ...
                if (sc == null) {
                    System.err.println("test.CMWinServerEventHandler.processUserEvent(): reqRecv, socket channel not found, key("
                            + nChKey + "), user(" + strUser + ")!");
                    return;
                }
                ...
                if (due == null) {
                    System.err.println("test.CMWinServerEventHandler.processUserEvent(): reqRecv, failed to receive a dummy event!");
                    return;
                }
                ...
                if (dc == null) {
                    System.err.println("test.CMWinServerEventHandler.processUserEvent(): reqRecv, datagram channel not found, recvPort("
                            + nRecvPort + ")!");
                    return;
                }
    ...
    private void processUserEvent_start_csc_ftp_session(CMUserEvent ue) {
        ...
        if (CMInfo._CM_DEBUG) {
            System.out.println("test.CMWinServerEventHandler.processUserEvent_start_csc_ftp_session(): ");
