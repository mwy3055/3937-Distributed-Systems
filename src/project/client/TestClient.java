...
public class TestClient extends JFrame {
    ...
    private void setMenus() {
        ...
        /* WordSendingEvent */
        JMenuItem sendWordEvent = new JMenuItem("send wordevent");
        sendWordEvent.addActionListener(menuListener);
        eventSubMenu.add(sendWordEvent);
    ...
    public void testWordEvent() {
        ...
        printMessage("====== test wordEvent in current group\n");
        ...
        printMessage("======word sending event: " + strInput + "\n");
    }
    ...
    public void printAllMenus() {
        ...
        printMessage("990: test wordEvent");
        ...
        if (option == JOptionPane.OK_OPTION) {
            ...
            for (int i = 0, j = 0; i < nFieldNum * 2; i += 2, j++) {
                if (dataTypeBoxes[j].getSelectedIndex() == CMInfo.CM_BYTES) {
                    ...
                    if (nValueByteNum < 0) {
                        printMessage("test.CMClientApp.testUserEvent(), Invalid nValueByteNum("
                                + nValueByteNum + ")\n");
