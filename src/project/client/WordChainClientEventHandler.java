...
public class WordChainClientEventHandler implements CMAppEventHandler {
    ...
    private void processUserEvent_end_csc_ftp_session(CMUserEvent ue) {
        ...
        if (CMInfo._CM_DEBUG) {
            System.out.println("test.CMWinClientEventHandler.processUserEvent_end_csc_ftp_session(): ");
    ...
    private void checkCompleteC2CFTPSession(CMFileEvent fe) {
        ...
        if (CMInfo._CM_DEBUG) {
            System.out.println("test.CMWinClientEventHandler.checkCompleteC2CFTPSession(), ");
